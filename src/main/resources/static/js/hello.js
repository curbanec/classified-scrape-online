...
angular.module('hello', [ 'ngRoute' ])
  ...
  .controller('home', function($rootScope, $http, $location) {
    ...
    /*$.getScript("../build/js/custom.js", function(data, textStatus, jqxhr) {
		console.log('Load was performed for custom.js.');
		}); */
  })
...
/*  .controller('etc', function($rootScope, $http, $location) {*/